...
def find_clusters_and_survival(reduced_dim_file_name, total_gene_list_file_name, gene_expression_file_name, phenotype_file_name, survival_file_name, gene_filter_file_name=None, tested_gene_list_path=None, total_gene_list_path=None, gene_expression_path=None, phenotype_path=None, gene_filter_file_path=None, var_th_index=None, is_unsupervised=True, start_k=2, end_k=2, meta_groups=None, filter_expression=None, clustering_algorithm="euclidean"):
    ...
    if is_unsupervised:
        ...
        for i in range(start_k,end_k+1):
            km_curve(clfs_results[i], survival_dataset[1:], gene_expression_top_var_headers_rows, reduced_dim_file_name.split(".")[0], i)
        ...
        for i, cur_groups in enumerate(meta_groups):
            ...
            km_curve(labeled_patients, survival_dataset[1:], gene_expression_top_var_headers_rows, reduced_dim_file_name.split(".")[0], label_index=i)
